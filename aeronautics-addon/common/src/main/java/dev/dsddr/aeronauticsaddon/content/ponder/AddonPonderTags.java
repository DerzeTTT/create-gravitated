...
public class AddonPonderTags {
    public static final ResourceLocation FLIGHT_CRYSTALS = ResourceLocation.fromNamespaceAndPath("aeronautics_addon", "flight_crystals");
    ...
    public static void register(final PonderTagRegistrationHelper<ResourceLocation> helper) {
        ...
        helper.registerTag(FLIGHT_CRYSTALS)
                .addToIndex()
                .item(AddonBlocks.GRAVITITE.asItem())
                .title("Flight Crystals")
                .description("Crystals that shape gravity and ship stability")
                .register();

        itemHelper.addToTag(FLIGHT_CRYSTALS)
